...
* Introduces a new file format for timed wallpapers: The **Simple Timed Wallpaper** format: [Web](pkg/simpletimed/README.md) | [Markdown](pkg/simpletimed/stw-1.0.0.md) | [PDF](simpletimed/pkg/stw-1.0.0.pdf)
